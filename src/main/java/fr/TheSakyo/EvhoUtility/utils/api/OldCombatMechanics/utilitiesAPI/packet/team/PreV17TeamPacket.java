...
public class PreV17TeamPacket extends TeamPacket {
    ...
    protected PreV17TeamPacket(Object nmsPacket) { super(nmsPacket); }
    ...
    @Override
    public Collection<String> getPlayerNames() { return PACKET_ACCESS.getPlayerNames(getNmsPacket()); }
    ...
    @Override
    public TeamAction getAction() { return PACKET_ACCESS.getAction(getNmsPacket()); }

    @Override
    public String getName() { return PACKET_ACCESS.getName(getNmsPacket()); }
    ...
    private static class PacketAccess {
        ...
        public void setCollisionRule(Object packet, CollisionRule rule) { Reflector.doUnchecked(() -> fieldCollisionRule.set(packet, rule.getName())); }

        public TeamAction getAction(Object packet) { return Reflector.getUnchecked(() -> TeamAction.fromId((Integer) fieldAction.get(packet))); }

        public void setAction(Object packet, TeamAction action) { Reflector.doUnchecked(() -> fieldAction.set(packet, action.getMinecraftId())); }
        ...
        public Object createTeamPacket(TeamAction action, CollisionRule collisionRule, String name, Collection<Player> players) {
            ...
            Reflector.doUnchecked(() -> fieldPlayerNames.set(packet, players.stream().map(Player::getName).collect(Collectors.toList())));
