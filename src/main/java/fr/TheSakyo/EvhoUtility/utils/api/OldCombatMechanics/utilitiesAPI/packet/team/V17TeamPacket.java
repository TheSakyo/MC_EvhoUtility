...
public class V17TeamPacket extends TeamPacket {
    ...
    @Override
    public Collection<String> getPlayerNames() { return PacketAccess.getPlayerNames(getNmsPacket()); }
    ...
    private static class PacketAccess {
        ...
        public static TeamAction getAction(Object packet) { return Reflector.getUnchecked(() -> TeamAction.fromId((Integer) fieldAction.get(packet))); }

        public static Object setAction(Object packet, TeamAction action) {

            return Reflector.getUnchecked(() -> constructorTeamPacket.newInstance(getName(packet), action.getMinecraftId(), fieldDataOptional.get(packet), getPlayerNames(packet)));
        }
        ...
        public static Object setCollisionRule(Object packet, CollisionRule rule) {
            ...
            return Reflector.getUnchecked(() -> {
                ...
                return constructorTeamPacket.newInstance(getName(packet), getAction(packet).getMinecraftId(), Optional.of(data), getPlayerNames(packet));
            });
        }
        ...
        public static Object createTeamPacket(TeamAction action, CollisionRule collisionRule, String name, Collection<Player> players) {
            ...
            Object packet = Reflector.getUnchecked(() -> constructorTeamPacket.newInstance(name, action.getMinecraftId(),Optional.empty(),
    ...
    private static abstract class ScoreboardTeamMethods {
        ...
        private static ScoreboardTeamMethods selectInstance() {
            ...
            if(Reflector.versionIsNewerOrEqualAs(1, 18, 0)) { return new ScoreboardTeamMethodsV18(); }
    ...
    private static class ScoreboardTeamWither {
        ...
        public ScoreboardTeamWither withCollisionRule(CollisionRule collisionRule) { this.collisionRule = collisionRule.getName(); return this; }
        ...
        public Object build() {
            ...
            Reflector.invokeMethod(ScoreboardTeamMethods.getInstance().setAllowFriendlyFire, team, (packOptionData & 0b1) != 0);
            Reflector.invokeMethod(ScoreboardTeamMethods.getInstance().setCanSeeFriendlyInvisibles, team, (packOptionData & 0b10) != 0);
            Reflector.invokeMethod(ScoreboardTeamMethods.getInstance().setNameTagVisibility, team, OptionalDataClassHelper.parseNameTagVisibility(nameTagVisibility));
            Reflector.invokeMethod(ScoreboardTeamMethods.getInstance().setCollisionRule, team, OptionalDataClassHelper.parseTeamPush(collisionRule));
        ...
        public static ScoreboardTeamWither from(Object dataClass){
            ...
            return new ScoreboardTeamWither(OptionalDataClassHelper.getDisplayName(dataClass), OptionalDataClassHelper.getPackOptionData(dataClass),
                    ...
                    OptionalDataClassHelper.getPrefix(dataClass), OptionalDataClassHelper.getSuffix(dataClass));
        }
    }
