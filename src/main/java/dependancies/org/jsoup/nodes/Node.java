...
import dependancies.org.jsoup.SerializationException;
...
public abstract class Node implements Cloneable {
    ...
    public Node wrap(String html) {
        ...
        if(!(wrapNode instanceof Element wrap)) return this;
     ...
     * @see dependancies.org.jsoup.nodes.Element#elementSiblingIndex()
     */
