package dependancies.org.jsoup;

import dependancies.org.jsoup.helper.DataUtil;
import dependancies.org.jsoup.helper.HttpConnection;
import dependancies.org.jsoup.nodes.Document;
import dependancies.org.jsoup.parser.Parser;
import dependancies.org.jsoup.safety.Cleaner;
import dependancies.org.jsoup.safety.Safelist;
import dependancies.org.jsoup.safety.Whitelist;
...
public class Jsoup {
     ...
     * Use examples:
     * <ul>
     *  <li><code>Document doc = Jsoup.connect("<a href="http://example.com">http://example.com</a>").userAgent("Mozilla").data("name", "jsoup").get();</code></li>
     *  <li><code>Document doc = Jsoup.connect("<a href="http://example.com">http://example.com</a>").cookie("auth", "token").post();</code></li>
     * </ul>
...
Document doc1 = session.newRequest()
     .url("<a href="https://jsoup.org/">https://jsoup.org/</a>").data("ref", "example")
     .get();
Document doc2 = session.newRequest()
     .url("<a href="https://en.wikipedia.org/wiki/Main_Page">https://en.wikipedia.org/wiki/Main_Page</a>")
     .get();
