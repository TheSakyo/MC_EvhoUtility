package dependancies.org.jsoup.select;

import dependancies.org.jsoup.helper.Validate;
import dependancies.org.jsoup.nodes.Comment;
import dependancies.org.jsoup.nodes.Document;
import dependancies.org.jsoup.nodes.DocumentType;
import dependancies.org.jsoup.nodes.Element;
import dependancies.org.jsoup.nodes.Node;
import dependancies.org.jsoup.nodes.PseudoTextElement;
import dependancies.org.jsoup.nodes.TextNode;
import dependancies.org.jsoup.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static dependancies.org.jsoup.internal.Normalizer.lowerCase;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<dependancies.org.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (dependancies.org.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    dependancies.org.jsoup.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
