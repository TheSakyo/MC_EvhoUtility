...
import dependancies.org.jsoup.parser.TokenQueue;
...
public class QueryParser {
    ...
    private void combinator(char combinator) {
        ...
        switch(combinator) {
            case '>' -> currentEval = new CombiningEvaluator.And(new StructuralEvaluator.ImmediateParent(currentEval), newEval);
            case ' ' -> currentEval = new CombiningEvaluator.And(new StructuralEvaluator.Parent(currentEval), newEval);
            case '+' -> currentEval = new CombiningEvaluator.And(new StructuralEvaluator.ImmediatePreviousSibling(currentEval), newEval);
            case '~' -> currentEval = new CombiningEvaluator.And(new StructuralEvaluator.PreviousSibling(currentEval), newEval);
            case ',' -> {
            ...
            default -> throw new Selector.SelectorParseException("Unknown combinator: " + combinator);
        }
