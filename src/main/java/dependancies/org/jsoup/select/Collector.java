...
import static dependancies.org.jsoup.select.NodeFilter.FilterResult.CONTINUE;
import static dependancies.org.jsoup.select.NodeFilter.FilterResult.STOP;
...
public class Collector {
    ...
    private static class Accumulator implements NodeVisitor {
        ...
        public void head(Node node, int depth) { if(node instanceof Element el) { if(eval.matches(root, el)) elements.add(el); } }
    ...
    private static class FirstFinder implements NodeFilter {
        ...
        public FilterResult head(Node node, int depth) {
            ...
            if(node instanceof Element el) { if(eval.matches(root, el)) { match = el; return STOP; } }
            return CONTINUE;
        }
